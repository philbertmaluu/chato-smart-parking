      ...
      <DialogContent className="sm:max-w-[500px]">
        <DialogHeader>
          <DialogTitle className="text-2xl font-bold text-gradient flex items-center space-x-3">
            ...
            <span>New Vehicle Detected</span>
          </DialogTitle>
          <DialogDescription className="text-base mt-2">
            A new plate number has been detected. Please select the vehicle body type to proceed with parking entry.
          </DialogDescription>
        </DialogHeader>
          ...
          <div className="space-y-6 mt-4">
            ...
            <div className="flex items-start space-x-2 p-3 bg-yellow-50 dark:bg-yellow-900/20 rounded-lg border border-yellow-200 dark:border-yellow-800">
              ...
              <p className="text-sm text-yellow-800 dark:text-yellow-200">
                Once you select the vehicle type, the vehicle will be registered and parking entry will be processed automatically.
              </p>
            </div>
