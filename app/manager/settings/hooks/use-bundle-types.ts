...
export const useBundleTypes = () => {
  ...
  const fetchBundleTypes = async (page: number = 1) => {
    setLoading(true);
    setError(null);
    try {
  ...
  const createBundleType = async (data: CreateBundleTypeData) => {
    setLoading(true);
    setError(null);
    try {
      const created = await post<BundleType>(
  ...
  const updateBundleType = async (data: UpdateBundleTypeData) => {
    setLoading(true);
    setError(null);
    try {
      const updated = await put<BundleType>(
  ...
  const deleteBundleType = async (id: number) => {
    setLoading(true);
    setError(null);
    try {
  ...
  const toggleActiveStatus = async (id: number, isActive: boolean) => {
    ...
    setError(null);
    try {
      const updated = await post<BundleType>(
