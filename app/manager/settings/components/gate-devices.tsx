    ...
    <div className="space-y-6">
      <div>
        <p className="text-muted-foreground">
          Manage hardware devices (cameras and boom gates) integrated with parking gates
        </p>
      </div>
      ...
      <Dialog open={isCreateDialogOpen} onOpenChange={setIsCreateDialogOpen}>
        <DialogContent className="sm:max-w-[600px]">
          <DialogHeader>
            ...
            <DialogDescription>
              Configure a new camera or boom gate device for a parking gate.
            </DialogDescription>
          </DialogHeader>
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="grid gap-2">
                ...
                <Select
                  ...
                  onValueChange={(value: "camera" | "boom_gate") =>
                ...
                >
                  ...
                  <SelectContent>
                    ...
                    <SelectItem value="boom_gate">Boom Gate</SelectItem>
                  </SelectContent>
                </Select>
              </div>
