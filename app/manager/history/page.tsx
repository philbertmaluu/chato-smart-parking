...
export default function ParkingHistory() {
  ...
  const exportToCSV = () => {
    ...
    link.setAttribute(
      "download",
      `parking_history_${
        mounted ? format(new Date(), "yyyy-MM-dd") : "data"
      }.csv`
    );
...
Generated: ${mounted ? format(new Date(), "PPP 'at' HH:mm") : "Report"}
...
Report generated by Smart Parking System
    ...
    const link = document.createElement("a");
    link.href = url;
    link.download = `parking_history_report_${
      mounted ? format(new Date(), "yyyy-MM-dd_HH-mm") : "data"
    }.txt`;
    document.body.appendChild(link);
    link.click();
    document.body.removeChild(link);
